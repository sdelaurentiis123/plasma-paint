...
Dedicated Rusty checkout: `/mnt/home/sdelaurentiis/ceph/plasma-paint-runs/20260904-rusty/vision-context-v1`, source `d2705c1`. Public model weights reside inside this checkout, not the previous run's model directory. The existing virtual environment is reused read-only. No dependency installation or unrelated job modifications are required.
