...
python -m pip install transformers==4.56.2 peft==0.17.1 accelerate==1.10.1 numpy==2.1.2 scipy==1.16.2 scikit-image==0.25.2 Pillow==11.3.0 imageio==2.37.0 matplotlib==3.10.6 PyYAML==6.0.3 huggingface-hub==0.35.3
